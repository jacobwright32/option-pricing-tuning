...
class PricingModel:
    ...
    def generate_signal(self, chain, price_history):
        ...
        if iv_rv_ratio > 1.85 and ret_5d < -0.015 and dist_from_low < 0.03:
            ...
            return (0.8 + skew_boost + term_boost + ivrv_boost + accel1 + pc_boost) * low_scale * coherence
            ...
            return (0.40 + skew_boost * 0.3 + term_boost * 0.3 + accel2 + pc_boost * 0.9) * low_scale * coherence
